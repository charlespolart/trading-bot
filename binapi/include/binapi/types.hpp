...
struct new_orderOCO_resp_type {
    static new_orderOCO_resp_type parse(const char *str, std::size_t len);
    friend std::ostream &operator<<(std::ostream &os, const new_orderOCO_resp_type &o);
};
